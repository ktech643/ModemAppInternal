...
const FashionWeeksAgenda = (props) => {
  ...
  const [carouselItems, setCarouselItems] = useState(
    allFashionWeeksAgendas.length && allFashionWeeksAgendas[0]?.banners
  );
  ...
  const renderMonthWiseFashionAgendas =
    allFashionWeeksAgendas.length &&
    Object.keys(allFashionWeeksAgendas[0].indexes).length ? (
      Object.keys(allFashionWeeksAgendas[0].indexes).map((index, key) => (
            ...
            >
              <View style={{ paddingVertical: 60 }}>
                <Text style={styles.gernalHeading}>
                  {allFashionWeeksAgendas && allFashionWeeksAgendas[0]?.title}
                </Text>
              </View>
              ...
              <View style={styles.btnGroup}>
                <TouchableOpacity
                  onPress={() => {
                    fetchFashionWeeksAgenda(
                      allFashionWeeksAgendas[0].previous_season_url
                    );
                  }}
                  style={styles.btn}
                >
                ...
                <TouchableOpacity
                  onPress={() => {
                    fetchFashionWeeksAgenda(
                      allFashionWeeksAgendas[0].next_season_url
                    );
                  }}
                  style={styles.btn}
                >
