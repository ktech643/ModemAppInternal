import {
  FETCH_FASHION_WEEKS_AGENDA_REQUEST_SENT,
  FETCH_FASHION_WEEKS_AGENDA_SUCCESSFUL,
  FETCH_FASHION_WEEKS_AGENDA_FAILURE,
  FETCH_SALES_COMPAIGNS_BRANDS_REQUEST_SENT,
  FETCH_SALES_COMPAIGNS_BRANDS_SUCCESSFUL,
  FETCH_SALES_COMPAIGNS_BRANDS_FAILURE,
  FETCH_SALES_COMPAIGNS_TRADESHOWS_REQUEST_SENT,
  FETCH_SALES_COMPAIGNS_TRADESHOWS_SUCCESSFUL,
  FETCH_SALES_COMPAIGNS_TRADESHOWS_FAILURE,
  FETCH_INTERNATION_AGENDA_SENT,
  FETCH_INTERNATION_AGENDA_SUCCESSFUL,
  FETCH_INTERNATION_AGENDA_FAILED,
  FETCH_SALES_COMPAIGNS_MULTILABEL_SHOWROOMS_REQUEST_SENT,
  FETCH_SALES_COMPAIGNS_MULTILABEL_SHOWROOMS_SUCCESSFUL,
  FETCH_SALES_COMPAIGNS_MULTILABEL_SHOWROOMS_FAILURE,
} from "../type";
...
export const fetchFashionWeeksAgenda = (param) => async (dispatch) => {
  ...
  try {
    ...
    console.log(
      "params",
      `${BASEURL}/apilfashion_week_calendar_api.php?${param}`
    );
    let resp;
    if (param == "") {
...
export const fetchSalesCompaignsMultiLabelShowrooms =
  () => async (dispatch) => {
    dispatch({
    ...
    try {
      const resp = await axios.get(
        `${BASEURL}/sales_campaigns_showrooms_api.php`,
        {
          headers: {
            "Content-Type": "application/json",
            Accept: "application/json",
...
export const fetchSalesCompaignsTradeShows = () => async (dispatch) => {
  ...
  try {
    const resp = await axios.get(
      `${BASEURL}/sales_campaigns_tradeshows_api.php`,
      {
        headers: {
          "Content-Type": "application/json",
          Accept: "application/json",
  ...
  try {
    ...
    if (param == "") {
      ...
      resp = await axios.get(
        `${BASEURL}/tradeshows_calendar_api.php?m=${param}`,
        {
          headers: {
            "Content-Type": "application/json",
            Accept: "application/json",
